...
coverage report -file ../modules/doc/covhtmlreports/byduReport.txt -bydu -detail -all -dump -fecanalysis -metricanalysis -option -assert -directive -cvg -codeAll
coverage report -file ../modules/doc/covhtmlreports/byinstanceReport.txt -byinstance -detail -all -dump -fecanalysis -metricanalysis -option -assert -directive -cvg -codeAll
coverage report -file ../modules/doc/covhtmlreports/byfileReport.txt -byfile -detail -all -dump -fecanalysis -metricanalysis -option -assert -directive -cvg -codeAll
coverage report -file ../modules/doc/covhtmlreports/report.txt -byfile -totals -assert -directive -cvg -codeAll
quit
